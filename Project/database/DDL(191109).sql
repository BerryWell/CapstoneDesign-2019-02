...
CREATE TABLE IF NOT EXISTS `mydb`.`floor` (
  ...
  PRIMARY KEY (`idfloor`),
  INDEX `fk_floor_mall_idx` (`mall_idmall` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`item` (
  ...
  `quantity` INT NULL,
  PRIMARY KEY (`iditem`),
  INDEX `fk_item_category1_idx` (`category_idcategory` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`member_manager` (
  ...
  INDEX `fk_member_manager_mall1_idx` (`mall_idmall` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`shoppinglist` (
  ...
  INDEX `fk_shoppinglist_member_customer1_idx` (`member_customer_idmember_customer` ASC) VISIBLE,
  INDEX `fk_shoppinglist_category1_idx` (`category_idcategory` ASC) VISIBLE,
