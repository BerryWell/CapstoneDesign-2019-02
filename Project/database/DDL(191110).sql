...
-- 2019년 11월 10일 (일) 오후 05시 34분 42초
...
CREATE TABLE IF NOT EXISTS `mydb`.`category` (
  ...
  INDEX `fk_category_mall1_idx` (`mall_idmall` ASC),
  CONSTRAINT `fk_category_mall1`
    FOREIGN KEY (`mall_idmall`)
    REFERENCES `mydb`.`mall` (`idmall`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `mydb`.`item` (
  ...
  INDEX `fk_item_mall1_idx` (`mall_idmall` ASC),
  CONSTRAINT `fk_item_category1`
    FOREIGN KEY (`category_idcategory`)
    REFERENCES `mydb`.`category` (`idcategory`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_item_mall1`
    FOREIGN KEY (`mall_idmall`)
    REFERENCES `mydb`.`mall` (`idmall`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `mydb`.`shoppinglist` (
  ...
  INDEX `fk_shoppinglist_mall1_idx` (`mall_idmall` ASC),
  ...
  CONSTRAINT `fk_shoppinglist_category1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_shoppinglist_mall1`
    FOREIGN KEY (`mall_idmall`)
    REFERENCES `mydb`.`mall` (`idmall`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
