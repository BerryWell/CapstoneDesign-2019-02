...
-- 2019년 11월 10일 (일) 오후 09시 27분 21초
...
CREATE TABLE IF NOT EXISTS `mydb`.`mall` (
  ...
  `max_floor` INT NULL,
  `member_manager_idmember_manager` INT NOT NULL,
  PRIMARY KEY (`idmall`),
  INDEX `fk_mall_member_manager1_idx` (`member_manager_idmember_manager` ASC),
  CONSTRAINT `fk_mall_member_manager1`
    FOREIGN KEY (`member_manager_idmember_manager`)
    REFERENCES `mydb`.`member_manager` (`idmember_manager`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
